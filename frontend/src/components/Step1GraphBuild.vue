    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            O LLM analisa o conteúdo do documento e os requisitos da simulação, extrai sementes reais e gera automaticamente a estrutura de ontologia adequada
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Com base na ontologia gerada, os documentos são automaticamente segmentados e o Zep é utilizado para construir o grafo de conhecimento, extraindo entidades e relações, formando memória temporal e resumos de comunidades
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">A construção do grafo foi concluída. Prossiga para a próxima etapa para configurar o ambiente de simulação</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Criando...' : 'Iniciar Configuração do Ambiente ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// Entrar na configuração do ambiente - criar simulation e redirecionar
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    console.error('Exceção ao criar simulação:', err)
    alert('Exceção ao criar simulação: ' + err.message)
  } finally {
